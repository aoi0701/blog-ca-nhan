...
<p align="center">
  <em>Minh họa quá trình đóng gói và truyền dữ liệu trong mạng máy tính thông qua ví dụ gói quà.</em>
</p>
...
<p align="center">
  <em>Minh họa mô hình TCP/IP và quá trình chia nhỏ, truyền và ghép lại dữ liệu giữa hai thiết bị qua mạng.</em>
</p>
...
<p align="center">
  <em>Mô hình Client–Server, trong đó client gửi yêu cầu (request) và server xử lý, phản hồi (response).</em>
</p>
...
<p align="center">
  <em>Minh họa mô hình các tầng TCP/IP trong quá trình truyền dữ liệu giữa máy gửi và máy nhận.</em>
</p>
