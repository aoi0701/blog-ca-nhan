...
Bài viết này sẽ giúp bạn hiểu rõ **TCP Socket là gì**, cách hoạt động và cách lập trình TCP Socket trong Java.
...
- Đảm bảo **đúng thứ tự – không mất dữ liệu**
- Hoạt động theo mô hình **Client – Server**
- Java dùng `ServerSocket` và `Socket`
- TCP sử dụng I/O Stream để truyền dữ liệu
